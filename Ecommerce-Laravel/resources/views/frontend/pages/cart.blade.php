                                    ...
                                    @foreach(Helper::getAllProductFromCart() as $key => $cart)
                                        @if($cart->product)
                                            <tr>
                                                ...
                                                @endphp
                                                <td class="image" data-title="No"><img src="{{ $photo[0] ?? 'default.png' }}" alt="{{ $photo[0] ?? 'default.png' }}"></td>
                                                ...
                                                <td class="total-amount cart_single_price" data-title="Total"><span class="money">${{ number_format($cart->price * $cart->quantity, 2) }}</span></td>
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        @endphp
                                        <li class="order_subtotal" data-price="{{ $total_amount }}">Cart Subtotal<span>${{ number_format($total_amount, 2) }}</span></li>
