...
@section('title','Chefzen || PRODUCT PAGE')
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
									...
									@endforeach
								@else
									<h4 class="text-danger" style="margin:100px auto;">Sorry, there are no products yet. Try selecting different one to see more results.</h4>
								@endif
							</div>
							 <div class="row">
